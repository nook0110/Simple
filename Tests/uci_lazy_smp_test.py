...
def main() -> int:
    ...
    expected_tuning_options = {
        ...
        "option name KnightMobilityMG type spin default 4 min 0 max 12",
        "option name KnightMobilityEG type spin default 2 min 0 max 12",
        "option name BishopMobilityMG type spin default 7 min 0 max 12",
        "option name BishopMobilityEG type spin default 3 min 0 max 12",
        "option name RookMobilityMG type spin default 2 min 0 max 10",
        "option name RookMobilityEG type spin default 4 min 0 max 10",
        "option name QueenMobilityMG type spin default 2 min 0 max 8",
        "option name QueenMobilityEG type spin default 2 min 0 max 8",
