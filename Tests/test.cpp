...
namespace AttackMapTests
{
    ...
    protected:
        [[nodiscard]] Bitboard GetMask() const
        {
            ...
            return GenerateAttackMask<sliding_piece>(test_case.square, test_case.occupancy);
        }
    ...
    INSTANTIATE_TEST_CASE_P(RandomBoardBishop, BishopMaskTest,
        testing::Values(TestCase{ Bitboard{0x40c601f030da9200}, 52, Bitboard{0x2800284402010000} },
            TestCase{ Bitboard{0x20346a0215120000}, 19, Bitboard{0x14001422} },
            TestCase{ Bitboard{0x600120400c222288}, 53, Bitboard{0x5000508804000000} },
            ...
            TestCase{ Bitboard{0x1062002008502088}, 55, Bitboard{0x4000402000000000} },
            ...
            TestCase{ Bitboard{0x21010a151a405350}, 44, Bitboard{0x4428002844820100} },
            ...
            TestCase{ Bitboard{0x8200c0002ca0c488}, 55, Bitboard{0x4000400000000000} },
            TestCase{ Bitboard{0x6600e00418318140}, 43, Bitboard{0x2214001420408000} }));

    INSTANTIATE_TEST_CASE_P(RandomBoardRook, RookMaskTest,
        testing::Values(TestCase{ Bitboard{0x40c601f030da9200}, 52, Bitboard{0x106c101000000000} },
            TestCase{ Bitboard{0x20346a0215120000}, 19, Bitboard{0x80808160808} },
            TestCase{ Bitboard{0x600120400c222288}, 53, Bitboard{0x20df200000000000} },
            ...
            TestCase{ Bitboard{0x1062002008502088}, 55, Bitboard{0x8040808080808080} },
            ...
            TestCase{ Bitboard{0x21010a151a405350}, 44, Bitboard{0x1010e81000000000} },
            ...
            TestCase{ Bitboard{0x1213089000011c26}, 62, Bitboard{0xb040404040404040} },
            ...
            TestCase{ Bitboard{0x8200c0002ca0c488}, 55, Bitboard{0x807f800000000000} },
            TestCase{ Bitboard{0x6600e00418318140}, 43, Bitboard{0x808370808000000} }));
    ...
    protected:
        ...
        {
            auto test_case = GetParam();
            return AttackTable<sliding_piece>::GetAttackMap(test_case.square, test_case.occupancy);
        }
        [[nodiscard]] Bitboard GetAnswer() const
        {
            auto test_case = GetParam();
    ...
    TEST_P(BishopAttackMapTest, AttackMap)
    {
        ASSERT_EQ(GetMask(), GetAnswer());
    }

    TEST_P(RookAttackMapTest, AttackMap)
    {
        ASSERT_EQ(GetMask(), GetAnswer());
    }
    ...
    INSTANTIATE_TEST_CASE_P(RandomBoardRook, RookAttackMapTest,
        testing::Values(TestCaseWithoutAnswer{ Bitboard{0x40c601f030da9200}, 52 },
            TestCaseWithoutAnswer{ Bitboard{0x20346a0215120000}, 19 },
            TestCaseWithoutAnswer{ Bitboard{0x600120400c222288}, 53 },
            TestCaseWithoutAnswer{ Bitboard{0xc240904011582201}, 4 },
