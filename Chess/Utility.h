...
constexpr BitIndex kBoardArea = 64;
constexpr Bitboard kEmptyBoard = Bitboard{};
constexpr uint8_t kLineSize = 8;
constexpr uint8_t kColors = 2;
constexpr uint8_t kPieceTypes =
    7;  // For Pawn, Knight, Bishop, Rook, Queen, King and Empty Square
constexpr uint8_t kMaxSearchPly = 1 << 5;
